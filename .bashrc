...
bash_prompt() {
	...
	local PROMT_USER=$"$TEXT_FORMAT_4 \u "
	local PROMT_HOST=$"$TEXT_FORMAT_2 \h "
	local PROMT_HOST1=$"$TEXT_FORMAT_5 \h "
	...
	local SEPARATOR_4=$SEPARATOR_FORMAT_4
	...
	*)
	...
	PS1="$TITLEBAR\n${PROMT_USER}${PROMT_HOST1}${PROMT_PWD}${SEPARATOR_4}${PROMT_INPUT}"
